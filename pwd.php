...
<div class="col-md-9 text-center">
    <h1 class="text-center text-white" style="background-color: #45526e">Change Password</h1>
    <div class="card mb-3">
        <div class="card-body">
          <form method="post" action="include/changepwd.php">
            Current Password:<br>
            <input type="password" name="currentPassword" id="myInput"><span id="currentPassword" class="required"><i style="color:red">*</i></span>
            <br>
            New Password:<br>
            <input type="password" name="newPassword" id="myInput1"><span id="newPassword" class="required"><i style="color:red">*</i></span>
            <br>
            Confirm Password:<br>
            <input type="text" name="confirmPassword"><span id="confirmPassword" class="required"><i style="color:red">*</i></span>
            <br>
            <input style="text-align: left;" type="checkbox" onclick="myFunction();myFunction1()"> Show Password
            <br>
            <input type="submit" class="btn btn-primary btn-block col-lg-3 m-auto d-block" value="Change Password">
          </form>
        </div>
    </div>
</div>
